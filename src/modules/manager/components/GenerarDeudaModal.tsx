              ...
              {clientesQ.data && (
                <ul className="divide-y divide-[var(--color-border)]">
                  {mappings.map((m, i) => {
                    ...
                    return (
                      <li key={m.facturaId} className={`grid grid-cols-1 gap-2 rounded-md px-2 py-2 md:grid-cols-[24px_1fr_1fr_auto] md:items-center ${!m.incluir || yaExiste ? 'bg-[rgba(255,255,255,.025)]' : ''}`}>
                        <input
                          type="checkbox"
