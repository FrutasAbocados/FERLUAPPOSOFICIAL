-- Cierre de caja: el efectivo mostrado era BRUTO (solo lineas de reparto),
-- sin restar los gastos que el repartidor paga de la caja (gasolina, compras,
-- incidencias). Anadimos gastos + efectivo_neto al RPC semanal.
