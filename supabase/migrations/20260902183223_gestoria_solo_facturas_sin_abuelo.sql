-- Gestoría debe conciliar con Holded > Ventas > Facturas. Esa pantalla suma
-- invoice + salesreceipt (factura simplificada/ticket).
-- Los albaranes se facturan a fin de mes: exponer ambos duplica facturación.
-- Las ventas internas de la frutería El Abuelo tampoco se comparten con Gedofu.
