-- ============================================================================
-- Caja · Estadísticas por semana × trabajador
-- ============================================================================
-- Fuente: repartos_jornada + repartos_jornada_lineas
-- Para un rango [p_from, p_to], devuelve una fila por (semana ISO, empleado)
-- con horas trabajadas, efectivo, tarjeta, total y nº de jornadas.
-- ============================================================================
