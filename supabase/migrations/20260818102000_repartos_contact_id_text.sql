-- Cierre propio: manager_contactos usa IDs Holded de texto (24 caracteres),
-- no UUID. El cast a uuid bloqueaba el envío desde que el buscador empezó a
-- incluir contact_id en las líneas del repartidor.
