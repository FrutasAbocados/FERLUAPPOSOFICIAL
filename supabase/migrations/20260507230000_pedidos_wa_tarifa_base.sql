-- Tarifa base por producto: cuando no hay precio histórico para un cliente
-- concreto, usamos un precio fallback derivado de los últimos 60 días de
-- ventas a CUALQUIER cliente del mismo product_id Holded.
--
-- Antes: línea sin histórico → 0€
-- Ahora: línea sin histórico → tarifa_base (avg últimos 60d) → 0€
