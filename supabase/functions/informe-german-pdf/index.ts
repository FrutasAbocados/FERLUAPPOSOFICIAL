// Edge Function: informe-german-pdf
// ----------------------------------------------------------------------------
// Enlace privado por token para el informe de clientes y comisión de Germán.
...
Deno.serve(async (req) => {
  ...
  if (!link || !/^german\/\d{4}-\d{2}-\d{2}\/[a-f0-9]{32}\.pdf$/.test(link.storage_path)) return texto('Enlace no válido', 404)
